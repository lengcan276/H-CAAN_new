...
if __name__ == "__main__":
    # 创建结果目录
    base_path = '/home/nudt_cleng/ccleng/MMFDL-main/notebook/0423/new_ML'
    ...
    # 加载数据
    print("Loading data...")
    train_data = formDataset(root='/home/nudt_cleng/ccleng/MMFDL-main/notebook/0423/results/processed/results/processed', dataset='Lipophilicity_MFBERT_dataTrain')
    train_ratio = 0.8
    ...
    test_data = formDataset(root='/home/nudt_cleng/ccleng/MMFDL-main/notebook/0423/results/processed/results/processed', dataset='Lipophilicity_MFBERT_dataTest')
